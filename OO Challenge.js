...
//Also, if the garage is at capacity, it should say “Sorry, we’re full.”
    ...
    class Garage{
        ...
        add(vehicle){
            ...
            if (this.vehicles.length >= this.capacity){ // if the length of the vehicles array is greater than or equal to the number in capacity 
                return "Sorry, we're full."
            }
          this.vehicles.push(vehicle); // adding the vehicle value to the vehicles array
